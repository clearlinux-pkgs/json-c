...
Source0  : https://s3.amazonaws.com/json-c_releases/releases/json-c-0.15.tar.gz
Summary  : A JSON implementation in C
Group    : Development/Tools
License  : MIT
Requires: json-c-filemap = %{version}-%{release}
...
%package filemap
Summary: filemap components for the json-c package.
Group: Default

%description filemap
filemap components for the json-c package.
...
%prep
%setup -q -n json-c-0.15
cd %{_builddir}/json-c-0.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644259228
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/json-c-0.15/COPYING %{buildroot}/usr/share/package-licenses/json-c/0cd23537e3c32497c7b87157b36f9d2eb5fca64b
pushd clr-build32
%make_install32
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-json-c
