...
Source0  : https://s3.amazonaws.com/json-c_releases/releases/json-c-0.18.tar.gz
...
%prep
%setup -q -n json-c-0.18
cd %{_builddir}/json-c-0.18
pushd ..
cp -a json-c-0.18 build32
popd
pushd ..
cp -a json-c-0.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726582466
mkdir -p clr-build
pushd clr-build
...
-DENABLE_THREADING=ON  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libjson-c.so.5.4.0
